...
"ERROR: could not find record for $fe\n";
                    ...
                    $ppc->dispose();
                    if ( $GA21type =~ /partially/i ) {
                        my $p_genotype2_id = '+/+';
                        my $p_genotype1_id = $genotype2_id;
                        my $p_pc           = create_ch_phenotype_comparison(
                            doc             => $doc,
                            genotype1_id    => $p_genotype1_id,
                            pub_id          => $ph{pub},
                            genotype2_id    => $p_genotype2_id,
                            phenotype1_id   => 'unspecified',
                            phenotype2_id   => 'unspecified',
                            environment1_id => 'unspecified',
                            environment2_id => 'unspecified',
                        ...
                        my $p_pc_cv = create_ch_phenotype_comparison_cvterm(
                            doc       => $doc,
                            cvterm_id => create_ch_cvterm(
                                doc  => $doc,
                                name => $cvterm,
